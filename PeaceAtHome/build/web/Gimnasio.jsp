<%-- 
    Document   : Gimnasio
    Created on : 18/08/2025, 23:33:20
    Author     : kikec
--%>
...
<body>
    ...
    <header>
        <h1>Servicio de Gimnasio</h1>
    </header>

    <main>
        <img src="Imagenes/imagen11.png" alt="Gimnasio de hotel">

        <section>
            <p>
                Disfrute de las mejores maquinas para hacer ejercicio.
            </p>
            <p>
                Esperamos que sea de su agrado este gimnasio.
            </p>
            <ul>
                <li><strong>Horario Disponible:</strong> 07:00 - 23:00</li>
                <li><strong>Costo Extra:</strong> Q150.00</li>
                <li><strong>Código de Reserva para horario:</strong> 67890</li>
            </ul>
        </section>

        <section>
            <a href="compra.html">Compra servicio de Gimnasio</a>
        </section>
    </main>
