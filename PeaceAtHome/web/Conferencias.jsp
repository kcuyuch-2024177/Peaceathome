<%-- 
    ...
    Created on : 18/08/2025, 23:31:45
    Author     : kikec
--%>
...
<body>
    ...
    <header>
        <h1>Servicio de Salas</h1>
    </header>

    <main>
        <img src="Imagenes/imagen15.png" alt="Salas de Hotel">

        <section>
            <p>
                Un espacio amplio para actividades de nuestros clientes.
            </p>
            <p>
                Un sitio libre incluido con el hotel, Esperamos que sea de su agrado.
            </p>
            <ul>
                <li><strong>Horario Disponible:</strong> 08:00 - 20:00</li>
                <li><strong>Costo Extra:</strong> Q200.00</li>
                <li><strong>Código de Reserva para horario:</strong> 67890</li>
            </ul>
        </section>

        <section>
            <a href="compra.jsp">Compra Salas de conferencia</a>
        </section>
    </main>
