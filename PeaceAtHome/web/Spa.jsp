<%-- 
    Document   : Spa
    Created on : 18/08/2025, 23:36:15
    Author     : kikec
--%>
...
<body>
    ...
    <header>
        <h1>Servicio de Spa y Masajes </h1>
    </header>

    <main>
        <img src="Imagenes/imagen13.png" alt="Spa Hotelario">
        ...
        <section>
            <a href="compra.html">Compra servicio de Spa</a>
        </section>
    </main>
